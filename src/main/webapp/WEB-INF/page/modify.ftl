                ...
                <div class="panel-form">
                    <form id="goodsAddForm" class="form-horizontal form-login">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="goodsName" name="goodsName" value="${goods.title}" class="form-control">
                                <input type="hidden" id="goodsId" name="goodsId" value="${goods.id?c}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="goodsSummary" class="col-sm-2 control-label">商品摘要</label>
                            <div class="col-sm-10">
                                <input type="text" id="goodsSummary" name="goodsSummary" value="${goods.summary}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="goodsPrice" class="col-sm-2 control-label">商品价格</label>
                            <div class="col-sm-10">
                                <input type="number" id="goodsPrice" name="goodsPrice" value="${goods.price?c}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="goodsDetail" name="goodsDetail" rows="5">${goods.content}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#publishDone">修改</button>
                                <button id="goBackButton" type="button" class="btn btn-default">返回</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="publishButton" class="btn btn-success" data-dismiss="modal">确认</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
